...
class YakimovIMultiplicationOfSparseMatricesCRSStorageFormatMPI : public BaseTask {
 public:
  static constexpr ppc::task::TypeOfTask GetStaticTypeOfTask() {
    return ppc::task::TypeOfTask::kMPI;
  }
  explicit YakimovIMultiplicationOfSparseMatricesCRSStorageFormatMPI(const InType &in);
